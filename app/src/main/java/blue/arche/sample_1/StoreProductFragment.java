...
public class StoreProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext()).load(storeInstance.productImage).fit().centerInside().into(targetImage);
        ...
        shopNearMe.setOnClickListener(new View.OnClickListener() {
            ...
            //Navigate to the Shop Near Me Activity
                Intent mappreview=new Intent(getActivity(),NearMeActivity.class);
                startActivity(mappreview);
